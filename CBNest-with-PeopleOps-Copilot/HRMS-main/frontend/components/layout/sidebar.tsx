...
import { ActivitySquare, Bell, CalendarClock, CalendarDays, CalendarPlus2, CircleDollarSign, FileText, LayoutDashboard, ScrollText, Sparkles, Ticket, UserCircle2, Users, Vote } from "lucide-react";
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive && "bg-gradient-to-r from-indigo-500/20 to-transparent text-white ring-1 ring-indigo-400/20"
              )}
            >
              <span
                className={cn(
